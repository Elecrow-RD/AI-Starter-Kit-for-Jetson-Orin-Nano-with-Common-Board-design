...
2. Download the image file to the local device, e.g., download the file [**jetson20260519.img**](https://drive.google.com/file/d/1X4fg_Uw89tWvzhUIHTL9dtetr0ouBHCr/view?usp=sharing) to your local storage.
