...
2. Download the image file to the local device, e.g., download the file [**jetson20260519.img**](https://drive.google.com/file/d/1YCVNjQpiVTVwAN_LFtx5Ax_9Ty8sa4Qh/view?usp=sharing) to your local storage.
